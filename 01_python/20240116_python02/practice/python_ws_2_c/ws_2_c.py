...
first_data = {}
page_data = data[0]['results'][0]['properties']
title = page_data['제목']['title'][0]['plain_text']
day = int(page_data['일차']['number'])
level = f"{page_data['단계']['select']['name']}단계"
subject = page_data['과목']['multi_select'][0]['name']

first_data = {'제목' : title, '일차' : day, '단계' : level, '과목' : subject}
print(first_data)