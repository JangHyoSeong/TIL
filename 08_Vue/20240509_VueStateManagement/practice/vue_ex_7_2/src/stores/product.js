...
export const useProductStore = defineStore('product', () => {
  ...
  const deleteProduct = function (targetProductId) {
    const productIdx = products.value.findIndex((product) => product.id === targetProductId)
    console.log(productIdx)
    products.value.splice(productIdx, 1)
  }
